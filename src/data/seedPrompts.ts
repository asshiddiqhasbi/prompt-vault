...
export const DEFAULT_CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    slug: "pm",
    description: "Prompt untuk PRD, requirement gathering, dan spek produk",
    color: { bg: "bg-purple-950/60", text: "text-purple-300", border: "border-purple-800/50" }
  },
  {
    id: "design",
    name: "UI/UX Design",
    slug: "design",
    description: "Design brief, design tokens, dan panduan antarmuka",
    color: { bg: "bg-cyan-950/60", text: "text-cyan-300", border: "border-cyan-800/50" }
  },
  {
    id: "security",
    name: "Security",
    slug: "security",
    description: "Security audit, pencarian celah keamanan, dan hardening",
    color: { bg: "bg-amber-950/60", text: "text-amber-300", border: "border-amber-800/50" }
  },
  {
    id: "engineering",
    name: "Engineering",
    slug: "engineering",
    description: "Debugging error, refactoring dead code, dan git commit",
    color: { bg: "bg-blue-950/60", text: "text-blue-300", border: "border-blue-800/50" }
  },
  {
    id: "testing",
    name: "Testing",
    slug: "testing",
    description: "E2E testing Playwright dan kualifikasi kualitas software",
    color: { bg: "bg-emerald-950/60", text: "text-emerald-300", border: "border-emerald-800/50" }
  },
  {
    id: "skill",
    name: "Skill Workflow",
    slug: "skill",
    description: "Mengubah alur kerja berulang menjadi reusable skill",
    color: { bg: "bg-rose-950/60", text: "text-rose-300", border: "border-rose-800/50" }
  }
];
...
export const SEED_PROMPTS: PromptItem[] = [
  {
    id: "prompt-1-prd",
    title: "1/ Tulis PRD Lengkap",
    description: "Berhenti mulai dengan 'buatin aplikasi'. Mulai dengan spek yang ditulis bareng AI.",
    content: `Kamu adalah senior product manager. Saya butuh PRD lengkap untuk produk di bawah ini.

Ide produk: {{IDE_PRODUK}}
...
Spesifik dan tegas. Tanpa basa-basi. Kalau ada requirement ambigu, tandai sebagai pertanyaan terbuka, jangan mengarang sendiri.`,
    categoryId: "pm",
    tags: ["#prd", "#product-manager", "#spec", "#planning"],
    isFavorite: true,
    createdAt: "2026-09-15T00:00:00.000Z",
    updatedAt: "2026-09-15T00:00:00.000Z"
  },
  {
    id: "prompt-2-design-brief",
    title: "2/ Full UI & UX Design Brief",
    description: "Desain dulu sebelum ngoding. Bikin aplikasimu tidak keliatan template purple gradient generik.",
    content: `Kamu adalah senior product designer. Berdasarkan PRD di atas, buatkan design brief lengkap sebelum satu baris kode pun ditulis.
...
Ambil keputusan yang tegas dan jelaskan alasannya. Hindari default yang generic. Kalau pilih font atau warna, jelaskan kenapa itu cocok untuk produk ini.`,
    categoryId: "design",
    tags: ["#design-system", "#ui-ux", "#design-brief", "#tokens"],
    isFavorite: true,
    createdAt: "2026-09-15T00:00:00.000Z",
    updatedAt: "2026-09-15T00:00:00.000Z"
  },
  {
    id: "prompt-3-security-audit",
    title: "3/ Temukan Celah Keamanan",
    description: "Step yang paling sering dilewatin. Jalankan sebelum deploy, bukan sesudah.",
    content: `Berperanlah sebagai application security engineer yang melakukan audit pre-launch pada codebase ini.
...
Lalu urutkan semua temuan berdasarkan severity. JANGAN ubah kode apapun sebelum saya approve. Kalau satu kategori bersih, katakan eksplisit, jangan diam saja.`,
    categoryId: "security",
    tags: ["#security", "#audit", "#vulnerability", "#secops"],
    isFavorite: true,
    createdAt: "2026-09-15T00:00:00.000Z",
    updatedAt: "2026-09-15T00:00:00.000Z"
  },
  {
    id: "prompt-4-debug-error",
    title: "4/ Debug Error dengan Cepat",
    description: "Membunuh death loop 'coba ini... eh coba yang ini deh'.",
    content: `Saya ada bug. JANGAN tulis fix dulu.

Error / perilaku yang tidak diharapkan: {{ERROR_LOG}}
Yang saya harapkan: {{EKSPEKTASI}}
Yang sebenarnya terjadi: {{REALITA}}
Kode relevan: {{KODE_RELEVAN}}
Yang sudah saya coba: {{YANG_SUDAH_DICOBA}}
...
Jangan shotgun perubahan. Jangan refactor kode yang tidak terkait. Jangan benerin hal yang tidak saya minta.`,
    ...
    tags: ["#debugging", "#error-fixing", "#root-cause", "#troubleshooting"],
    isFavorite: false,
    createdAt: "2026-09-15T00:00:00.000Z",
    updatedAt: "2026-09-15T00:00:00.000Z"
  },
  {
    id: "prompt-5-e2e-playwright",
    title: "5/ E2E Test Aplikasimu (Playwright)",
    description: "Ship tanpa deg-degan.",
    content: `Setup end-to-end testing untuk aplikasi ini dengan Playwright.

1. Install dan konfigurasi Playwright untuk stack ini: {{TECH_STACK}}. Tambahkan config untuk local + CI, dengan retry, trace saat gagal, dan screenshot.
...
Jelaskan cara menjalankan semuanya. Tandai journey yang tidak bisa dites secara reliable dan jelaskan kenapa.`,
  ...
  {
    id: "prompt-6-cleanup-refactor",
    title: "6/ Bersihkan & Refactor Dead Code",
    description: "Vibecoding ninggalin banyak sampah kode. Codebase yang ramping bikin respons AI makin pintar.",
    content: `Berperanlah sebagai senior engineer yang melakukan cleanup pass di repo ini. Kerjakan dalam dua fase dan berhenti di antaranya.
...
Aturan: behaviour harus tetap identik, tidak ada dependency baru, tidak ada rename public API. Kasih saya ringkasan tiap perubahan supaya bisa saya review diff-nya.`,
    categoryId: "engineering",
    tags: ["#refactoring", "#clean-code", "#audit", "#dead-code"],
    isFavorite: false,
    createdAt: "2026-09-15T00:00:00.000Z",
    updatedAt: "2026-09-15T00:00:00.000Z"
  },
  {
    id: "prompt-7-git-commit",
    title: "7/ Tulis Git Commit yang Rapi",
    description: "Nggak ada lagi 'fix stuff' x40. History commit-mu jadi dokumentasi.",
    content: `Review perubahan saya saat ini (staged dan unstaged) dan susun jadi commit yang rapi.
...
Jangan pernah tulis pesan samar seperti "update", "fix stuff", "changes" atau "wip".`,
    categoryId: "engineering",
    tags: ["#git", "#commit-convention", "#devops", "#documentation"],
    isFavorite: false,
    createdAt: "2026-09-15T00:00:00.000Z",
    updatedAt: "2026-09-15T00:00:00.000Z"
  },
  {
    id: "prompt-8-task-to-skill",
    title: "8/ Ubah Task Jadi Skill",
    description: "Yang paling compounding. Kerjain sekali, tidak usah jelasin ulang lagi.",
    content: `Kita baru saja menyelesaikan satu task bersama. Ubah jadi reusable Skill supaya saya tidak perlu menjelaskannya lagi.

Task-nya: {{DESKRIPSI_TASK}}
...
Tulis supaya berdiri sendiri. Anggap pembacanya tidak tahu apa-apa soal project ini.`,
    categoryId: "skill",
    tags: ["#skill-creation", "#antigravity", "#reusable-workflow", "#automation"],
    isFavorite: true,
    createdAt: "2026-09-15T00:00:00.000Z",
    updatedAt: "2026-09-15T00:00:00.000Z"
  }
